	...
	<section id="answer">
		...
		<p>
			<?php
				...
				echo $daystil . ' days until Shark Week begins August 12';
			?>
		</p>
...
<div id="content" class="columns" role="main">
	...
	<p>Here's a compilation of shark-related goodies to keep you from plunging into shark-deprivation madness:</p>
		<ul class="dots">
		  ...
		  <li>Check out the <a href="#tv">programming and schedule for Shark Week 2012</a></li>
		  ...
		  <li>Play a <a href="#game">shark game</a></li>
