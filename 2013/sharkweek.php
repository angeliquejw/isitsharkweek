...
<!-- AddThis Button END -->
	<section id="answer">
      <h1>Yes</h1>
      <h2>!!!!!!!!!!!</h2>
      <p><a href="#tv">What&rsquo;s playing during Shark Week? &darr;</a></p>
      <p><a href="#content">Get more sharks! &darr;</a></p>
   </section>
</header>
<div id="content" class="columns" role="main">
	<h2>It's finally here&mdash;Shark Week!</h2>
	<p>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!</p>
		<ul class="dots">
		  <li>Check out the <a href="#tv">programming and schedule for Shark Week 2013</a></li>
		  <li><a href="#stream">Watch live sharks</a> in the National Aquarium's new blacktip reef exhibit via #sharkcam</li>
		  <li>Learn more about <a href="#learn">sharks</a></li>
		  <li>Give to a <a href="#donate">shark-related charity</a></li>
        <li>Oh, yeah. There was this thing called <a href="/sharknado/">Sharknado</a> last month and&mdash;unsurprisingly&mdash;I had some thoughts about that.</li>
