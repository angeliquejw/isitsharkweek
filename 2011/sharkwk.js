...
var s = new Date(2011,06,31);
var e = new Date(2011,07,07);
...
if ((current < startSW)) {
    ...
    document.write('<div id="header" class="center"> \n');
		...
		document.write (' more day until Shark Week begins on July 31</b><br /> \n');
//add back in S after day
    ...
    document.write('<div id="header" class="center"> \n');
		...
		document.write('<p><a href="#tv">What&rsquo;s playing during Shark Week? &darr;</a><br /><a href="#content">Get more sharks! &darr;</a></p>');
}