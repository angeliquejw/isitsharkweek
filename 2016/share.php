  ...
  <ul class="socialWrapper">
    <li>
      ...
      <?php
        if($status == 'early'){
          if($daystil > 1) {
            $twittershare = 'http://twitter.com/intent/tweet?text='.$daystil.'+Days+Until+%23SharkWeek+2016&url=http:%2F%2Fisitsharkweek.com'; 
          } else {
            $twittershare = 'http://twitter.com/intent/tweet?text='.$daystil.'+Day+Until+%23SharkWeek+2016&url=http:%2F%2Fisitsharkweek.com'; 
          }
        } else {
